const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-KlJ1Xkuh.js","assets/index-9qfdMu3b.css"])))=>i.map(i=>d[i]);
import { R as React, j as jsxRuntimeExports, r as reactExports, B as Button, u as useBackend, d as useAuth, f as useQuery, o as BookOpen, w as CertificateStatus, I as Input, x as TrainingType, U as Users, A as AttendanceStatus, h as useQueryClient, y as TrainingFrequency, i as useMutation, n as ue, m as Label, _ as __vitePreload } from "./index-KlJ1Xkuh.js";
  ...
  async function handleDownloadAll() {
    ...
    for (const att of presentWithCerts) {
      ...
      const { default: ReactDOM } = await __vitePreload(async () => {
        const { default: ReactDOM2 } = await import("./index-KlJ1Xkuh.js").then((n) => n.c);
