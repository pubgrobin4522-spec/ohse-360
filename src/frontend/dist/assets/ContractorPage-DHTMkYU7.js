import { a as createLucideIcon, r as reactExports, au as useControllableState, j as jsxRuntimeExports, aw as composeEventHandlers, at as Primitive, av as useComposedRefs, az as useDirection, aA as clamp, ax as useSize, ay as createContextScope, M as cn, aB as useBackendCall, d as useAuth, h as useQueryClient, f as useQuery, B as Button, aC as Building2, T as TriangleAlert, I as Input, aD as ContractorDocStatus, aE as InductionStatus, e as Role, aF as ContractorStatus, aG as PerformanceRating, m as Label, U as Users, n as ue } from "./index-KlJ1Xkuh.js";
...
import { u as usePrevious, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-07LXmFHp.js";
import { c as createCollection } from "./index-DhDE9dTE.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BaD-aY2q.js";
import { R as RefreshCw } from "./refresh-cw-lIVh7Ceb.js";
import { P as Plus } from "./x-De3qytGh.js";
...
import { A as Award } from "./award-DD6cu21N.js";
/**
...
function ContractorDetail({
  ...
  const linkedPtws = (linkedPtwQuery.data ?? []).filter(
    (p) => contractor.linkedPtwNumbers.includes(p.id)
  );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "info", className: "p-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "ptw", children: linkedPtws.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: ptw.id }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                ptw.permitType,
                " · ",
                ptw.jobLocation
